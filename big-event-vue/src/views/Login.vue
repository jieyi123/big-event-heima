...
const rules = {
  username: [
    ...
    { min: 5, max: 15, message: "用户名必须满足5-15位", trigger: "blur" },
  ],
  password: [
    { required: true, message: "请输入密码", trigger: "blur" },
    { min: 5, max: 15, message: "密码长度为5-15位", trigger: "blur" },
  ],
...
const register = async () => {
  //registerData是一个响应式对象，如需获取值，需要.value
